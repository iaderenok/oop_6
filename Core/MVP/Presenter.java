...
public class Presenter {
    ...
    public void add() {
        model.currentBook().add(
                new Contact(view.getFirstName(), view.getLastName(), view.getDescription(), view.getEmail(), view.getPhone()));
    }

    public void remove() {
        Contact contact = new Contact(view.getFirstName(), view.getLastName(), view.getDescription(), view.getEmail(), view.getPhone());
